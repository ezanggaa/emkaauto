...
function showTabelPerbandingan($jenis,$kriteria) {
	...
	<table class="ui celled selectable collapsing table">
		<thead>
			<tr>
				<th colspan="2">Memilih yang Lebih Penting</th>
				...
				<td>
					<div class="field">
						<div class="ui radio checkbox">
							...
							<label style="font-size:16px;"><?php echo $pilihan[$x]; ?></label>
						</div>
					</div>
				</td>
				<td>
					<div class="field">
						<div class="ui radio checkbox">
							...
							<label style="font-size:16px;"><?php echo $pilihan[$y]; ?></label>
						</div>
					</div>
				</td>
				<td>
	...
	<input class="ui teal submit button" type="submit" name="submit" value="SUBMIT">
	</form>
	...
	<?php
		...
		function filter($request) {
			global $koneksi;
			return mysqli_real_escape_string($koneksi, htmlspecialchars($request));
		}
